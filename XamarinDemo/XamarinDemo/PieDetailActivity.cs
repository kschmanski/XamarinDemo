...
using XamarinDemo.Utility;
using XamarinDemo.Core.Repository;
...
namespace XamarinDemo
{
    ...
    public class PieDetailActivity : Activity
    {
        ...
        private XamarinDemo.Core.Model.Pie _selectedPie;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(XamarinDemo.Resource.Layout.pie_detail);
